...
let DataPathSchema = new mongoose.Schema({
    parent: { type: String, unique: true, required: true },  // Nome da BusinessRule/Integracao atendida. Tbm possivel identificar se meta ou datapath pelo parent.modeltype
